...
public class DemoActivity extends Activity
    ...
    private long uId = 1167865228099662L;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateUI();
        // TODO: 2017/3/16
//        mUrlEditText.setText("rtmp://cncpublish.bingdou.tv/live/"+uId);
        ...
        switch (view.getId()) {
            case R.id.connectBT:
                ...
                if (!TextUtils.isEmpty(mUrlEditText.getText())
					&& mUrlEditText.getText().toString().length()>0) {
                    ...
                    ToastUtils.show(DemoActivity.this,"请输入一个直播名");
                }
                break;
            default:
                break;
